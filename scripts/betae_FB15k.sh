...
export SAVE_PATH=../logs/FB15k/betae_temp
export LOG_PATH=../logs/FB15k/betae_temp.out
export MODEL=temp
...
CUDA_VISIBLE_DEVICES=0 nohup python -u ../main.py --cuda --do_train --do_valid --do_test \
  ...
  --cpu_num 1 --geo beta -betam "(1600,2)" --test_batch_size 16 --tasks "1p.2p.3p.2i.3i.ip.pi.2in.3in.inp.pin.pni.2u.up" --print_on_screen \
